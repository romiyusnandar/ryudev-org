export default function Features() {
  const features = [
    ...
    {
      title: "24/7 Support",
      description: "Round-the-clock technical support with dedicated team ready to assist.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Simple integration process with comprehensive documentation and SDKs.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-6 rounded-xl bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 dark:border-gray-700"
            >
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 rounded-2xl py-12 px-8 text-white">
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses that trust RyuDev for their digital transformation.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="bg-white dark:bg-gray-900 text-blue-600 dark:text-blue-400 px-8 py-4 rounded-lg text-lg font-semibold border-2 border-blue-600 dark:border-blue-400 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-colors shadow-lg hover:shadow-xl">
              Schedule Demo
            </button>
          </div>
        </div>
