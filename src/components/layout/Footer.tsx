...
export default function Footer() {
  ...
  const footerLinks = {
    services: [
      ...
      { href: '#movie-streaming', label: 'Movie Streaming' },
    ...
    <footer className="bg-gray-800 dark:bg-gray-950 text-white transition-colors">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-300 mb-6">
              Providing comprehensive digital solutions including API testing, entertainment platforms,
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} RyuDev. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
